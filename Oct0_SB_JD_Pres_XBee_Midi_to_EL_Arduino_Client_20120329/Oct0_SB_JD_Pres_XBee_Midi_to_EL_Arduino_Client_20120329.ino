/* 
 ...
 //  20120329
 //  tech@sbeyer.com
 //  Octave 0 (Notes 00~11, I use notes 01~08)
 */
...
void playNote(byte note, byte velocity){
  ...
  if (note==1 && value==HIGH) { 
    EL.on(A); 
  } else if (note==1) { 
    EL.off(A); 
  }
  if (note==2 && value==HIGH) { 
    EL.on(B); 
  } else if (note==2) { 
    EL.off(B); 
  }
  if (note==3 && value==HIGH) { 
    EL.on(C); 
  } else if (note==3) { 
    EL.off(C); 
  }
  if (note==4 && value==HIGH) { 
    EL.on(D); 
  } else if (note==4) { 
    EL.off(D); 
  }
  if (note==5 && value==HIGH) { 
    EL.on(E); 
  } else if (note==5) { 
    EL.off(E); 
  }
  if (note==6 && value==HIGH) { 
    EL.on(7);  // yeah, it's "7", not F, dunno.
  } else if (note==6) { 
    EL.off(7);   // it's 7, not F.
  }
  if (note==7 && value==HIGH) { 
    EL.on(G); 
  } else if (note==7) { 
    EL.off(G); 
  }
  if (note==8 && value==HIGH) { 
    EL.on(H); 
  } else if (note==8) { 
    EL.off(H); 
  }
