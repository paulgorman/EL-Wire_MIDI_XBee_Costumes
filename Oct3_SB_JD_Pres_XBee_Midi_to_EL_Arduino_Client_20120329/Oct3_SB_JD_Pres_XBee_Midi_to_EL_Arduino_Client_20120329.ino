/* 
 ...
 //  20120329
 //  tech@sbeyer.com
 //  Octave 3 (Notes 36~47, I use notes 37~44)
 */
...
void playNote(byte note, byte velocity){
  ...
  if (note==37 && value==HIGH) { 
    EL.on(A); 
  } else if (note==37) { 
    EL.off(A); 
  }
  if (note==38 && value==HIGH) { 
    EL.on(B); 
  } else if (note==38) { 
    EL.off(B); 
  }
  if (note==39 && value==HIGH) { 
    EL.on(C); 
  } else if (note==39) { 
    EL.off(C); 
  }
  if (note==40 && value==HIGH) { 
    EL.on(D); 
  } else if (note==40) { 
    EL.off(D); 
  }
  if (note==41 && value==HIGH) { 
    EL.on(E); 
  } else if (note==41) { 
    EL.off(E); 
  }
  if (note==42 && value==HIGH) { 
    EL.on(7);  // yeah, it's "7", not F, dunno.
  } else if (note==42) { 
    EL.off(7);   // it's 7, not F.
  }
  if (note==43 && value==HIGH) { 
    EL.on(G); 
  } else if (note==43) { 
    EL.off(G); 
  }
  if (note==44 && value==HIGH) { 
    EL.on(H); 
  } else if (note==44) { 
    EL.off(H); 
  }
