/* 
 ...
 //  20120329
 //  tech@sbeyer.com
 //  Octave 1 (Notes 12~23, I use notes 13~20)
 */
...
void playNote(byte note, byte velocity){
  ...
  if (note==13 && value==HIGH) { 
    EL.on(A); 
  } else if (note==13) { 
    EL.off(A); 
  }
  if (note==14 && value==HIGH) { 
    EL.on(B); 
  } else if (note==14) { 
    EL.off(B); 
  }
  if (note==15 && value==HIGH) { 
    EL.on(C); 
  } else if (note==15) { 
    EL.off(C); 
  }
  if (note==16 && value==HIGH) { 
    EL.on(D); 
  } else if (note==16) { 
    EL.off(D); 
  }
  if (note==17 && value==HIGH) { 
    EL.on(E); 
  } else if (note==17) { 
    EL.off(E); 
  }
  if (note==18 && value==HIGH) { 
    EL.on(7);  // yeah, it's "7", not F, dunno.
  } else if (note==18) { 
    EL.off(7);   // it's 7, not F.
  }
  if (note==19 && value==HIGH) { 
    EL.on(G); 
  } else if (note==19) { 
    EL.off(G); 
  }
  if (note==20 && value==HIGH) { 
    EL.on(H); 
  } else if (note==20) { 
    EL.off(H); 
  }
