/* 
 ...
 //  20120329
 //  tech@sbeyer.com
 //  Octave 6 (Notes 72~83, I use notes 73-80)
...
void playNote(byte note, byte velocity){
  ...
  if (note==73 && value==HIGH) { 
    EL.on(A); 
  } else if (note==73) { 
    EL.off(A); 
  }
  if (note==74 && value==HIGH) { 
    EL.on(B); 
  } else if (note==74) { 
    EL.off(B); 
  }
  if (note==75 && value==HIGH) { 
    EL.on(C); 
  } else if (note==75) { 
    EL.off(C); 
  }
  if (note==76 && value==HIGH) { 
    EL.on(D); 
  } else if (note==76) { 
    EL.off(D); 
  }
  if (note==77 && value==HIGH) { 
    EL.on(E); 
  } else if (note==77) { 
    EL.off(E); 
  }
  if (note==78 && value==HIGH) { 
    EL.on(7);  // yeah, it's "7", not F, dunno.
  } else if (note==78) { 
    EL.off(7);   // it's 7, not F.
  }
  if (note==79 && value==HIGH) { 
    EL.on(G); 
  } else if (note==79) { 
    EL.off(G); 
  }
  if (note==80 && value==HIGH) { 
    EL.on(H); 
  } else if (note==80) { 
    EL.off(H); 
  }
